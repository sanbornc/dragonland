...
**Where we left off (Session 07):** the party rested safely on the seventh island of
[the Drowned Swamp](../wiki/locations/the-drowned-swamp.md), on the corpse of
[the Heart of the Swamp](../wiki/npcs/the-heart-of-the-swamp.md) — with a
[draconian](../wiki/npcs/draconians.md) scout somewhere in the fog, a dragon-shaped
silhouette out in the swamp, and a dead man's warning that **"it isn't a dragon."**
...
- **On a dais near the doors:** an object — **the remnants of a giant egg shell.**
- **On the two fighting dragons:** one dragon holds **a lance with a place for something to be
  placed**; the other has **a fist**, likewise **with a place for something to be placed.**

  *(Recorded as presented. — 🧩)*
- **[Boilerdang](../wiki/characters/boilerdang-criddlycrotch.md) walks up to the arguing
  individuals to try to talk.** **They tried to arrest him**, and **he ran.** *(No fight — and
  their identity, authority, and number still unrecorded.)*
- **🐻 The [Amulet of the Remembered Paw](../wiki/items/amulet-of-the-remembered-paw.md) is
  used for the first time** — **the larger bear** answers the call. *(First use in eight
  sessions; the mercy from Session 03 finally cashed in.)*
...
- **💀 [Hederick](../wiki/npcs/high-theocrat-hederick.md) is killed — again.** His **fifth**
  death. **Not revived before the session ended.**
- **💀 [Vaelor](../wiki/characters/vaelor-grinward.md) was killed by the warlock** —
  **[Renob](../wiki/characters/renob.md) brought him back with a potion.**
- **The warlock is still alive.**
- **🔚 Session ends mid-fight.** The party is **all quite hurt**, the warlock is up, the
  golden doors are untouched, and Hederick is dead on the ground. **Session 09 resumes here,
  in combat** — picking up in a couple of weeks.
...
- **🚪 Two massive golden doors** stand on the back wall of the entry room, covered in
  **symbols and warnings**, including **images of two dragons fighting.** A **dais** near the
  doors holds **the remnants of a giant egg shell.** One dragon's **lance** and the other's
  **fist** each have **a place for something to be placed.** **Unopened.** 🧩
...
- **🧩 The golden doors are unopened**, and both settings — the lance and the fist — are
  **empty.** *(Logged as presented; the party is working it.)*
- **What is the egg shell on the dais?**
- **💀 Is Hederick recoverable?** He died mid-combat and was **not revived** before the session
  ended. Revivify has a **1-minute** window and the fight is still running.
- **⚔️ The warlock is alive and the fight is unfinished.** Session 09 opens in combat.
- **Who are these people?** They tried to **arrest** the party rather than kill them, they are
  **translating old stories**, and one of them warned **against using force.** Scholars with
  guards, a rival expedition, or an authority the party has not met?
...
- *(carried)* **The four unclaimed magic items** and the
  [Mirewalker Ring](../wiki/items/mirewalker-ring.md) attunement.
- *(carried)* **Does the Forest Master's extra 4th-level slot refresh on a long rest?**
- *(carried)* **Are the dead Solamnic's sword and shield magical?**
- *(carried)* **Does Hederick ever learn what [Renob](../wiki/characters/renob.md) did?**
  *(Now complicated — he is dead again.)*
- *(carried)* **Who is [Fizban](../wiki/npcs/fizban.md), really?** ·
  **[Haven](../wiki/locations/haven.md) and [Elistan](../wiki/npcs/elistan.md) are
  unfinished.**

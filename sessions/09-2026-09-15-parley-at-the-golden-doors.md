...
**Where we left off (Session 08):** the party was mid-combat inside
[the Tomb of the Two Dragons](../wiki/locations/the-tomb-of-the-two-dragons.md) —
[Vaelor](../wiki/characters/vaelor-grinward.md) freshly raised by a potion,
[Hederick](../wiki/npcs/high-theocrat-hederick.md) dead on the ground,
...
- **✨ Vaelor notices the Solamnic mark he received is glowing slightly** — the
  **[Blessing of the Oathbound](../wiki/items/blessing-of-the-oathbound.md)** tattoo (a
...
- **The caster can be talked to.** After Session 08's arrest attempt and a killing blow on
  Vaelor, he **chose to spend a turn in conversation rather than attack** — the first
  successful contact with anyone from this camp.
  ([The Warlock at the Tomb](../wiki/npcs/the-warlock-at-the-tomb.md))
- **He wants to know how the party got into the tomb** — his first question back was
  **"How did you get in?"**, not a threat or a demand.
...
- **✨ Why is Vaelor's mark glowing, and when did it start?** Note that
  **[Pip](../wiki/characters/pip-tumblewhistle.md) is the only party member without the
  blessing** (Ryan was out for Session 02) — so any test of "does everyone's glow?" is a
  four-person check. 🧩
- *(carried from Session 08)* **The golden doors are unopened**, both settings — the
  **lance** and the **fist** — still empty. 🧩
- *(carried)* **What is the egg shell on the dais?**
- *(carried)* **💀 Is [Hederick](../wiki/npcs/high-theocrat-hederick.md) recoverable?**
- *(carried)* **What were the two dead mages translating?**
- *(carried)* **🐉 What is the "dragon"** that shat a polymorphed goblin?

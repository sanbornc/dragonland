...
type: character
player: TJ Smith
class: Sorcerer 7 (Shadow Magic)
race: Tiefling
background: Charlatan
alignment: True Neutral
sheet: https://dndbeyond.com/characters/150900703
...
- **Abilities:** STR 8 (−1) · DEX 14 (+2) · CON 15 (+2) · INT 10 (+0) · WIS 12 (+1) · CHA 18 (+4)
- **Saves:** Constitution & Charisma proficient
...
- **Shadow Magic:** Eyes of the Dark (Darkness), Strength of the Grave, Hound of
  Ill Omen
- **Core 2024 sorcerer:** Innate Sorcery, Metamagic, Font of Magic; at level 7
  **Sorcery Incarnate** and **Sorcerous Restoration**, plus a 4th-level spell slot

## Spellcasting (Charisma) — save DC 17, spell attack +9 (with the Custom Bloodwell Vial +2)
*Confirmed from the sheet: the **Custom Bloodwell Vial +2** adds +2 to both the
spell save DC and spell attack, so the base DC 15 / +7 becomes **DC 17 / +9**. While
**Innate Sorcery** is active, add a further +1 to the DC and roll spell attacks with
advantage.*
- **Cantrips:** Chill Touch, Fire Bolt, Mage Hand, Minor Illusion, Prestidigitation, Thaumaturgy
- **1st:** Chromatic Orb, Feather Fall, Shield, False Life, Magic Missile *(from wand)*
- **2nd:** Mirror Image, Misty Step, Suggestion, Web, Darkness, Ray of Enfeeblement, Scorching Ray
- **3rd:** Dispel Magic, Fireball, Hypnotic Pattern
- **4th:** a slot is available at level 7, but no 4th-level spell is recorded on the sheet yet

## Gear (heavily equipped)
- **Cloak of Displacement** (rare), **Elven Chain** (rare), **Custom Bloodwell
  Vial +2** (rare — arcane focus that stores sorcery points)
- **Broom of Flying**, **Circlet of Blasting**, **Bag of Holding**, **Pearl of
  Power**, **Wand of Magic Missiles** (all uncommon)
- 2× Greater Potion of Healing, 4× Potion of Healing, several daggers, antitoxin,
  caltrops, thieves' kit

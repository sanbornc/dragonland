...
sheet: https://dndbeyond.com/characters/137649468
...
- The structured personality fields (traits/ideals/bonds/flaws/appearance) are
  blank.
- **Caution:** the sheet's notes contain a backstory/secrets block that appears
  to be **leftover placeholder text** — it names a different character
  ("Caladorn Moonspire"), calls him an Oath of *Vengeance* paladin (his oath is

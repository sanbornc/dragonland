...
## What we know
- A place to "watch" — "too many paths meet under innocent roofs." ([Ringmaster's Ledger — Back-Cover List](../documents/ringmasters-ledger-back-cover-list.md))
- The north road follows the river toward Solace; "too visible by daylight." Spelled "Selace" on one page — likely the same place. ([Ringmaster's Ledger — Roads / Payments / Witnesses](../documents/ringmasters-ledger-roads-payments.md))
- Knights have been seen here, and "not all relics stay buried." ([Ringmaster's Ledger — Back-Cover List](../documents/ringmasters-ledger-back-cover-list.md))
- The torn map scrap questions a "swamp road? old stones?" near Solace. ([Ringmaster's Ledger — Torn Map Scrap / Old Road](../documents/ringmasters-ledger-map-scrap.md))
- Appears on the regional map. ([Burned Regional Map](../documents/regional-map-burned.md))
...
- **[High Theocrat Hederick](../npcs/high-theocrat-hederick.md) was killed, then revived
  and taken by the party** — found drinking at the Inn of the Last Home, he turned hostile,
  was **killed by [Boilerdang](../characters/boilerdang-criddlycrotch.md)** in a brawl, and
  then **brought back at 1 HP with Revivify** (leverage / prisoner). Solace's ruling
  theocrat is alive but in the party's hands; the town's fallout is unresolved. (Session 04)

## Open questions
- Is "Selace" a variant spelling or a different place?
- Do the **Seekers** run Solace, or just police its approaches? What are they

...
aliases: [Inn at the Last Home, Last Home]
type: location
tags: [solace, inn, tavern]
...
- An **inn in [Solace](solace.md).** (Session 03)
- Run by **[Tika](../npcs/tika.md)** — barmaid and **part owner**, who effectively
  runs the place — and **[Otik](../npcs/otik.md)**, the **cook and co-owner.**
  (Session 03)
...
- How does the party know Tika? What's their history with the Inn?

## See also

- [Solace](solace.md) · [Tika](../npcs/tika.md) · [Otik](../npcs/otik.md)
